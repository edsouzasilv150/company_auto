...
<html lang="pt">
        ...
        <div class="page-container">
            ...
            <div class="page-sidebar">
                ...
                <ul class="x-navigation">
                    <li class="xn-logo">
                        <a href="index.html">Company Auto</a>
                        <a href="#" class="x-navigation-control"></a>
                    </li>
                    <li class="xn-profile">
                        <a href="#" class="profile-mini">
                            <img src="assets/images/users/avatar.jpg" alt="logo"/>
                        </a>
                        <div class="profile">
                            ...
                            <div class="profile-data">
                                <div class="profile-data-name">Edsousa</div>
                                ...
                                <div class="panel-body panel-body-table">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-striped">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td><strong>Company Auto</strong></td>
    ...
    <?php
        session_start();
        // sessão que verifica usuário logado, manda para área restrita.
        if(isset($_SESSION ['id'] ) && empty($_SESSION ['id']) == false ) {
            echo "Área Restrita ..."; 
        // manda para área de login.       
        } else {
